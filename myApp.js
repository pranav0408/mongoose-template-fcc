...
var schema = new Schema(personSchema)
...
var pranav = new Person({'name':'Pranav','age':21,'favoriteFoods':['burger','taco']})
var createAndSavePerson = function(done) {
  
  pranav.save(function(err,data){
...
var findPeopleByName = function(personName, done) {
  var personName = {name:personName}
